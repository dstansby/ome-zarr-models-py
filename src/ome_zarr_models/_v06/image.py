...
class Image(BaseGroupv06[ImageAttrs]):
    ...
    def new(
        ...
        *,
        ...
        # Now this has input/output coord systems, add manually to transform registry
        TRANSFORM_REGISTRY.add_transform(output_coord_transform)
        print(output_coord_transform)
